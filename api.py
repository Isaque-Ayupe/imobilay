...
async def list_sessions(user_id: str):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Extracted datetime.now().date() calculations outside the loop
        # to prevent redundant system calls and O(N) object instantiations on every iteration.
