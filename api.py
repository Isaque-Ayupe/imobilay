...
async def list_sessions(user_id: str, authorization: str = Header(None)):
    ...
    """
    # Security: Validate authentication header to prevent IDOR and unauthorized access
    ...
    try:
        ...
        # Security: Use get_user_client instead of get_system_client to properly enforce RLS
