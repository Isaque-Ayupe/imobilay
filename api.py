...
async def list_sessions(user_id: str, authorization: str = Header(...)):
    ...
    try:
        ...
        # Security: Enforce proper authorization to prevent IDOR via RLS bypass.
        # Ensure the header follows the correct Bearer format before parsing the JWT.
        ...
        # Security: Use the context-aware user client to securely enforce Supabase RLS.
        # This replaces get_system_client() which previously bypassed all security checks.
