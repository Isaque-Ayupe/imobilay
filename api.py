...
async def list_sessions(user_id: str):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Extract invariant date calculations outside the loop
        # Avoids O(N) redundant system calls to get current date, making list rendering faster.
