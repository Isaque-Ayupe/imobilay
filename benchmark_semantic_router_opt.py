...
async def run_benchmark():
    ...
    intent_matrices = {
        name: np.vstack(embs) for name, embs in intent_embeddings.items()
    }
    ...
    for _ in range(5000):
        ...
        raw_scores = {}
        for intent_name, matrix in intent_matrices.items():
    ...
    print(f"OPTIMIZED: Time taken for 5000 routings: {duration:.4f} seconds")
